...
class GuidEntity extends IEntity {
    ...
    static grammar = Parsernostrum.reg(/[0-9A-F]{32}/i).map(v => new this(v)).label("GuidEntity")
...
class IPrintableEntity extends IEntity {
...
class InvariantTextEntity extends IPrintableEntity {
