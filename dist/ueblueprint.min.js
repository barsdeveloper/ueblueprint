 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const Kt=(e=>(...t)=>({_$litDirective$:e,values:t}))(class extends Xt{constructor(e){var t;if(super(e),e.type!==Wt||"style"!==e.name||(null===(t=e.strings)||void 0===t?void 0:t.length)>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce(((t,i)=>{const n=e[i];return null==n?t:t+`${i=i.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${n};`}),"")}update(e,[t]){const{style:i}=e.element;if(void 0===this.vt){this.vt=new Set;for(const e in t)this.vt.add(e);return this.render(t)}this.vt.forEach((e=>{null==t[e]&&(this.vt.delete(e),e.includes("-")?i.removeProperty(e):i[e]="")}));for(const e in t){const n=t[e];null!=n&&(this.vt.add(e),e.includes("-")?i.setProperty(e,n):i[e]=n)}return D}});class qt extends mt{toggleAdvancedDisplayHandler;getDraggableElement(){return this.element.querySelector(".ueb-window-top")}createDraggableObject(){return new ht(this.element,this.element.blueprint,{draggableElement:this.getDraggableElement(),ignoreTranslateCompensate:!0,movementSpace:this.element.blueprint,stepSize:1})}render(){return O`<div class="ueb-window"><div class="ueb-window-top"><div class="ueb-window-name ueb-ellipsis-nowrap-text">${this.renderWindowName()}</div><div class="ueb-window-close" @click="${()=>this.element.remove()}">${ut.close}</div></div><div class="ueb-window-content">${this.renderContent()}</div></div>`}renderWindowName(){return O`Window`}renderContent(){return O``}apply(){this.element.dispatchEvent(new CustomEvent(te.windowApplyEventName)),this.element.remove()}cancel(){this.element.dispatchEvent(new CustomEvent(te.windowCancelEventName)),this.element.remove()}}class Yt extends qt{#ze;#Ve;#Ge;#Fe;#je;#Ue;#We;#Xe;#Ke;#qe;#Ye=e=>{const t=le.clearHTMLWhitespace(e.target.innerHTML),i=parseInt(t,16);isNaN(i)||(this.color.setFromRGBANumber(i),this.element.requestUpdate())};#Ze=e=>{const t=le.clearHTMLWhitespace(e.target.innerHTML),i=parseInt(t,16);isNaN(i)||(this.color.setFromSRGBANumber(i),this.element.requestUpdate())};#Je=e=>t=>{"Enter"==t.code&&(t.preventDefault(),e(t))};#pe=new fe;get color(){return this.#pe}set color(e){e.toNumber()!=this.color?.toNumber()&&(this.element.requestUpdate("color",this.#pe),this.#pe=e)}#Qe=new fe;get fullColor(){return this.#Qe}#et;get initialColor(){return this.#et}#tt=new fe;#it(e,t,i=!1){const n=this.color.toRGBAString(),r=`${n.substring(0,2*e)}${t}${n.substring(2+2*e)}`;return i?`${r.substring(0,6)}FF`:r}connectedCallback(){super.connectedCallback(),this.#et=this.element.windowOptions.getPinColor(),this.color.setFromHSVA(this.initialColor.H.value,this.initialColor.S.value,this.initialColor.V.value,this.initialColor.A.value),this.fullColor.setFromHSVA(this.color.H.value,1,1,1)}firstUpdated(e){this.#ze=this.element.querySelector(".ueb-color-picker-wheel ueb-color-handler"),this.#Ve=this.element.querySelector(".ueb-color-picker-saturation ueb-ui-slider"),this.#Ge=this.element.querySelector(".ueb-color-picker-value ueb-ui-slider"),this.#Fe=this.element.querySelector(".ueb-color-picker-r ueb-ui-slider"),this.#je=this.element.querySelector(".ueb-color-picker-g ueb-ui-slider"),this.#Ue=this.element.querySelector(".ueb-color-picker-b ueb-ui-slider"),this.#We=this.element.querySelector(".ueb-color-picker-a ueb-ui-slider"),this.#Xe=this.element.querySelector(".ueb-color-picker-h ueb-ui-slider"),this.#Ke=this.element.querySelector(".ueb-color-picker-s ueb-ui-slider"),this.#qe=this.element.querySelector(".ueb-color-picker-v ueb-ui-slider"),this.#ze.template.locationChangeCallback=(e,t)=>{this.color.setFromWheelLocation([e,t],this.color.V.value,this.color.A.value),this.fullColor.setFromHSVA(this.color.H.value,1,1,1),this.element.requestUpdate()},this.#Ve.template.locationChangeCallback=(e,t)=>{this.color.setFromHSVA(this.color.H.value,t,this.color.V.value,this.color.A.value),this.element.requestUpdate()},this.#Ge.template.locationChangeCallback=(e,t)=>{this.color.setFromHSVA(this.color.H.value,this.color.S.value,t,this.color.A.value),this.element.requestUpdate()},this.#Fe.template.locationChangeCallback=(e,t)=>{this.color.setFromRGBA(e,this.color.G.value,this.color.B.value,this.color.A.value),this.element.requestUpdate()},this.#je.template.locationChangeCallback=(e,t)=>{this.color.setFromRGBA(this.color.R.value,e,this.color.B.value,this.color.A.value),this.element.requestUpdate()},this.#Ue.template.locationChangeCallback=(e,t)=>{this.color.setFromRGBA(this.color.R.value,this.color.G.value,e,this.color.A.value),this.element.requestUpdate()},this.#We.template.locationChangeCallback=(e,t)=>{this.color.setFromRGBA(this.color.R.value,this.color.G.value,this.color.B.value,e),this.element.requestUpdate()},this.#Xe.template.locationChangeCallback=(e,t)=>{this.color.setFromHSVA(e,this.color.S.value,this.color.V.value,this.color.A.value),this.element.requestUpdate()},this.#Ke.template.locationChangeCallback=(e,t)=>{this.color.setFromHSVA(this.color.H.value,e,this.color.V.value,this.color.A.value),this.element.requestUpdate()},this.#qe.template.locationChangeCallback=(e,t)=>{this.color.setFromHSVA(this.color.H.value,this.color.S.value,e,this.color.A.value),this.element.requestUpdate()}}renderSlider(e){let t="",i=0,n="";const r=e=>`linear-gradient(to right, #${this.#it(e,"00",!0)}, #${this.#it(e,"ff",!0)})`;switch(e){case 0:t="r",i=this.color.R.value,n=r(e);break;case 1:t="g",i=this.color.G.value,n=r(e);break;case 2:t="b",i=this.color.B.value,n=r(e);break;case 3:t="a",i=this.color.A.value,n=`${te.alphaPattern}, ${r(e)}`;break;case 4:t="h",i=360*this.color.H.value,n="linear-gradient(to right, #f00 0%, #ff0 16.666%, #0f0 33.333%, #0ff 50%, #00f 66.666%, #f0f 83.333%, #f00 100%)";break;case 5:t="s",i=this.color.S.value,n=`linear-gradient(to right,#${this.#tt.setFromHSVA(this.color.H.value,0,this.color.V.value,1),this.#tt.toRGBAString()},#${this.#tt.setFromHSVA(this.color.H.value,1,this.color.V.value,1),this.#tt.toRGBAString()})`;break;case 6:t="v",i=this.color.V.value,n=`linear-gradient(to right, #000, #${this.fullColor.toRGBAString()})`}return n=`background: ${n};`,O`<div class="ueb-color-picker-${t.toLowerCase()}"><span class="ueb-color-control-label">${t.toUpperCase()}</span><div><div class="ueb-horizontal-slider"><span class="ueb-horizontal-slider-text" .innerText="${le.minDecimals(le.roundDecimals(i,3))}"></span><ueb-ui-slider></ueb-ui-slider></div><div class="ueb-color-picker-gradient" style="${n}"></div></div></div>`}renderContent(){const e=2*this.color.H.value*Math.PI,t={"--ueb-color-r":this.color.R.toString(),"--ueb-color-g":this.color.G.toString(),"--ueb-color-b":this.color.B.toString(),"--ueb-color-a":this.color.A.toString(),"--ueb-color-h":this.color.H.toString(),"--ueb-color-s":this.color.S.toString(),"--ueb-color-v":this.color.V.toString(),"--ueb-color-wheel-x":100*(this.color.S.value*Math.cos(e)*.5+.5)+"%","--ueb-color-wheel-y":100*(this.color.S.value*Math.sin(e)*.5+.5)+"%"},i=this.color.toRGBAString(),n=this.color.toSRGBAString(),r=this.fullColor.toRGBAString();return O`<div class="ueb-color-picker" style="${Kt(t)}"><div class="ueb-color-picker-toolbar"><div class="ueb-color-picker-theme"></div><div class="ueb-color-picker-srgb"></div></div><div class="ueb-color-picker-main"><div class="ueb-color-picker-wheel"><ueb-color-handler></ueb-color-handler></div><div class="ueb-color-picker-saturation ueb-vertical-slider" style="background-color:#${r}"><ueb-ui-slider></ueb-ui-slider></div><div class="ueb-color-picker-value ueb-vertical-slider" style="background-color:#${r}"><ueb-ui-slider></ueb-ui-slider></div><div class="ueb-color-picker-preview">Old<div class="ueb-color-picker-preview-old" style="background:#${this.#et.toRGBAString()}"></div><div class="ueb-color-picker-preview-new"><div class="ueb-color-picker-preview-1" style="background:#${this.#it(3,"FF")}"></div><div class="ueb-color-picker-preview-2" style="background:${`linear-gradient(#${i}, #${i}),${te.alphaPattern}`}"></div></div>New</div></div><div class="ueb-color-picker-advanced-toggle ueb-toggle-control">Advanced</div><div class="ueb-color-picker-advanced"><div class="ueb-color-picker-column">${this.renderSlider(0)} ${this.renderSlider(1)} ${this.renderSlider(2)} ${this.renderSlider(3)}</div><div class="ueb-color-picker-column">${this.renderSlider(4)} ${this.renderSlider(5)} ${this.renderSlider(6)}<div class="ueb-color-control"><span class="ueb-color-control-label">Hex Linear</span><div class="ueb-color-picker-hex-linear ueb-text-input"><ueb-input .innerText="${i}" @focusout="${this.#Ye}" @keydown="${this.#Je(this.#Ye)}"></ueb-input></div></div><div class="ueb-color-control"><span class="ueb-color-control-label">Hex sRGB</span><div class="ueb-color-picker-hex-srgb ueb-text-input"><ueb-input .innerText="${n}" @focusout="${this.#Ze}" @keydown="${this.#Je(this.#Ze)}"></ueb-input></div></div></div></div><div class="ueb-buttons"><div class="ueb-color-picker-ok ueb-button" @click="${()=>this.apply()}">OK</div><div class="ueb-color-picker-cancel ueb-button" @click="${()=>this.cancel()}">Cancel</div></div></div>`}renderWindowName(){return O`Color Picker`}}class Zt extends St{#nt;#rt=e=>{e.preventDefault(),this.element.blueprint.setFocused(!0),this.#nt=new(Qe.getConstructor("ueb-window"))({type:Yt,windowOptions:{getPinColor:()=>this.element.defaultValue,setPinColor:e=>this.element.setDefaultValue(e)}}),this.element.blueprint.append(this.#nt);const t=()=>{this.element.setDefaultValue(this.#nt.template.color)},i=()=>{this.#nt.removeEventListener(te.windowApplyEventName,t),this.#nt.removeEventListener(te.windowCloseEventName,i),this.#nt=null};this.#nt.addEventListener(te.windowApplyEventName,t),this.#nt.addEventListener(te.windowCloseEventName,i)};renderInput(){return O`<span class="ueb-pin-input" data-linear-color="${this.element.defaultValue.toString()}" @click="${this.#rt}" style="--ueb-linear-color:rgba(${this.element.defaultValue.toString()})"></span>`}}class Jt extends Ft{static singleLineInput=!0}class Qt extends jt{setDefaultValue(e=[],t=e){this.element.setDefaultValue(e[0])}renderInput(){return O`<div class="ueb-pin-input"><ueb-input .singleLine="${!0}" .innerText="${Ft.stringFromUEToInput(le.minDecimals(this.element.entity.DefaultValue))}"></ueb-input></div>`}}class ei extends St{renderIcon(){return ut.referencePin}}class ti extends jt{setDefaultValue(e=[],t=e){if(!(this.element.entity.DefaultValue instanceof Pe))throw new TypeError("Expected DefaultValue to be a VectorEntity");let i=this.element.entity.DefaultValue;i.R=e[0],i.P=e[1],i.Y=e[2]}renderInput(){return O`<div class="ueb-pin-input-wrapper"><span class="ueb-pin-input-label">X</span><div class="ueb-pin-input"><span class="ueb-pin-input-content ueb-pin-input-x" role="textbox" contenteditable="true" .innerText="${Ft.stringFromUEToInput(this.element.entity.getDefaultValue().R.toString())}"></span></div><span class="ueb-pin-input-label">Y</span><div class="ueb-pin-input"><span class="ueb-pin-input-content ueb-pin-input-y" role="textbox" contenteditable="true" .innerText="${Ft.stringFromUEToInput(this.element.entity.getDefaultValue().P.toString())}"></span></div><span class="ueb-pin-input-label">Z</span><div class="ueb-pin-input"><span class="ueb-pin-input-content ueb-pin-input-z" role="textbox" contenteditable="true" .innerText="${Ft.stringFromUEToInput(this.element.entity.getDefaultValue().Y.toString())}"></span></div></div>`}}class ii extends Ft{}class ni extends jt{setDefaultValue(e,t){if(!(this.element.entity.DefaultValue instanceof ke))throw new TypeError("Expected DefaultValue to be a VectorEntity");let i=this.element.entity.DefaultValue;i.X=e[0],i.Y=e[1],i.Z=e[2]}renderInput(){return O`<div class="ueb-pin-input-wrapper"><span class="ueb-pin-input-label">X</span><div class="ueb-pin-input"><ueb-input .singleLine="${!0}" .innerText="${Ft.stringFromUEToInput(le.minDecimals(this.element.entity.getDefaultValue().X))}"></ueb-input></div><span class="ueb-pin-input-label">Y</span><div class="ueb-pin-input"><ueb-input .singleLine="${!0}" .innerText="${Ft.stringFromUEToInput(le.minDecimals(this.element.entity.getDefaultValue().Y))}"></ueb-input></div><span class="ueb-pin-input-label">Z</span><div class="ueb-pin-input"><ueb-input .singleLine="${!0}" .innerText="${Ft.stringFromUEToInput(le.minDecimals(this.element.entity.getDefaultValue().Z))}"></ueb-input></div></div>`}}class ri extends Ke{static#st={"/Script/CoreUObject.LinearColor":Zt,"/Script/CoreUObject.Rotator":ti,"/Script/CoreUObject.Vector":ni,bool:Vt,int:Ut,MUTABLE_REFERENCE:ei,name:Jt,real:Qt,string:ii};static properties={pinId:{type:de,converter:{fromAttribute:(e,t)=>e?Ie.grammar.Guid.parse(e).value:null,toAttribute:(e,t)=>e?.toString()},attribute:"data-id",reflect:!0},pinType:{type:String,attribute:"data-type",reflect:!0},advancedView:{type:String,attribute:"data-advanced-view",reflect:!0},color:{type:fe,converter:{fromAttribute:(e,t)=>e?Ie.grammar.LinearColorFromAnyColor.parse(e).value:null,toAttribute:(e,t)=>e?le.printLinearColor(e):null},attribute:"data-color",reflect:!0},defaultValue:{type:String,attribute:!1},isLinked:{type:Boolean,converter:le.booleanConverter,attribute:"data-linked",reflect:!0},pinDirection:{type:String,attribute:"data-direction",reflect:!0}};static getTypeTemplate(e){if(e.PinType.bIsReference&&!e.PinType.bIsConst)return ri.#st.MUTABLE_REFERENCE;if("exec"===e.getType())return Gt;let t;return e.isInput()&&(t=ri.#st[e.getType()]),t??St}nodeElement;connections=0;constructor(e,t,i){super(e,t??new(ri.getTypeTemplate(e))),this.pinId=this.entity.PinId,this.pinType=this.entity.getType(),this.advancedView=this.entity.bAdvancedView,this.defaultValue=this.entity.getDefaultValue(),this.color=ri.properties.color.converter.fromAttribute(this.getColor().toString()),this.isLinked=!1,this.pinDirection=e.isInput()?"input":e.isOutput()?"output":"hidden",this.nodeElement=i,this.entity.subscribe("PinToolTip",(e=>{let t=e.match(/\s*(.+?(?=\n)|.+\S)\s*/);return t?le.formatStringName(t[1]):le.formatStringName(this.entity.PinName)}))}getPinId(){return this.entity.PinId}getPinName(){return this.entity.PinName}getPinDisplayName(){return this.entity.getDisplayName()}getColor(){return te.getPinColor(this)}isInput(){return this.entity.isInput()}isOutput(){return this.entity.isOutput()}getLinkLocation(){return this.template.getLinkLocation()}getNodeElement(){return this.nodeElement}getLinks(){return this.entity.LinkedTo??[]}setDefaultValue(e){this.entity.DefaultValue=e,this.defaultValue=e}sanitizeLinks(e=[]){this.entity.LinkedTo=this.getLinks().filter((t=>{let i=this.blueprint.getPin(t);if(i){if(e.length&&!e.includes(i.nodeElement))return!1;this.blueprint.getLink(this,i,!0)||this.blueprint.addGraphElement(new(Qe.getConstructor("ueb-link"))(this,i))}return i}))}linkTo(e){this.entity.linkTo(e.getNodeElement().getNodeName(),e.entity)&&(this.isLinked=this.entity.isLinked(),this.nodeElement?.template.linksChanged())}unlinkFrom(e){this.entity.unlinkFrom(e.getNodeElement().getNodeName(),e.entity)&&(this.isLinked=this.entity.isLinked(),this.nodeElement?.template.linksChanged())}redirectLink(e,t){const i=this.entity.LinkedTo.findIndex((t=>t.objectName.toString()==e.getNodeElement().getNodeName()&&t.pinGuid.valueOf()==e.entity.PinId.valueOf()));return i>=0&&(this.entity.LinkedTo[i]=t,!0)}}class si extends qe{static#xe={window:qt,"color-picker":Yt};static properties={...qe.properties,type:{type:qt,attribute:"data-type",reflect:!0,converter:{fromAttribute:(e,t)=>si.#xe[e],toAttribute:(e,t)=>Object.entries(si.#xe).find((([t,i])=>e==i))[0]}}};constructor(e={}){e.type.constructor==String&&(e.type=si.#xe[e.type]),e.type??=qt,e.windowOptions??={},super({},new e.type),this.type=e.type,this.windowOptions=e.windowOptions}disconnectedCallback(){super.disconnectedCallback(),this.acknowledgeClose()}acknowledgeClose(){let e=new CustomEvent(te.windowCloseEventName);this.dispatchEvent(e)}}class oi extends Ie{constructor(e,t,i,n,r,s,o){e=e??(e=>`(${e})`),super(t,i,n,r,s,o),this.wrap=e}read(e){const t=Be.getGrammarForType(Ie.grammar,this.entityType).parse(e);if(!t.status)throw new Error(`Error when trying to parse the entity ${this.entityType.prototype.constructor.name}.`);return t.value}write(e,t,i=!1){return this.wrap(this.subWrite(e,[],t,i),t)}}class ai extends oi{#ot;constructor(e,t){super(void 0,t),this.#ot=e}write(e,t,i=!1){return this.#ot(t,i)}}class li extends oi{constructor(e){super(void 0,e)}write(e,t,i){return i||t.constructor!==String?le.escapeString(t.toString()):`"${le.escapeString(t.toString())}"`}}!function(){const e=e=>`(${e})`;se.registerSerializer(null,new ai(((e,t)=>"()"),null)),se.registerSerializer(Array,new ai(((e,t)=>`(${e.map((e=>se.getSerializer(le.getType(e)).serialize(e,t)+",")).join("")})`),Array)),se.registerSerializer(Boolean,new ai(((e,t)=>e?t?"true":"True":t?"false":"False"),Boolean)),se.registerSerializer(he,new oi(e,he)),se.registerSerializer(de,new li(de)),se.registerSerializer(pe,new li(pe)),se.registerSerializer(me,new li(me)),se.registerSerializer(ge,new oi((e=>`${ge.lookbehind}(${e})`),ge,"",", ",!1,"",(e=>""))),se.registerSerializer(be,new oi(e,be)),se.registerSerializer(fe,new oi(e,fe)),se.registerSerializer(ye,new oi((e=>`${ye.lookbehind}(${e})`),ye,"",", ",!1,"",(e=>""))),se.registerSerializer(we,new oi(e,we)),se.registerSerializer(Number,new ai((e=>e.toString()),Number)),se.registerSerializer(Ae,new Re),se.registerSerializer(ce,new ai((e=>(e.type??"")+(e.path?e.type?`'"${e.path}"'`:`"${e.path}"`:"")),ce)),se.registerSerializer(Ee,new li(Ee)),se.registerSerializer(Ne,new oi((e=>`${Ne.lookbehind} (${e})`),Ne,"",",",!0)),se.registerSerializer(Se,new oi((e=>e),Se,""," ",!1,"",(e=>""))),se.registerSerializer(ve,new li(ve)),se.registerSerializer(Pe,new oi(e,Pe)),se.registerSerializer(String,new ai(((e,t)=>t?le.escapeString(e):`"${le.escapeString(e)}"`),String)),se.registerSerializer(Ce,new ai(((e,t)=>`${e.P}, ${e.Y}, ${e.R}`),Ce)),se.registerSerializer(xe,new ai(((e,t)=>`${e.X}, ${e.Y}, ${e.Z}`),xe)),se.registerSerializer(Le,new li(Le)),se.registerSerializer(Oe,new oi(((e,t)=>`${t.lookbehind??""}(${e})`),Oe)),se.registerSerializer(Te,new oi(e,Te)),se.registerSerializer(ke,new oi(e,ke))}(),customElements.define("ueb-color-handler",Dt),Qe.registerElement("ueb-color-handler",Dt),customElements.define("ueb-input",_t),Qe.registerElement("ueb-input",_t),customElements.define("ueb-link",ct),Qe.registerElement("ueb-link",ct),customElements.define("ueb-node",xt),Qe.registerElement("ueb-node",xt),customElements.define("ueb-pin",ri),Qe.registerElement("ueb-pin",ri),customElements.define("ueb-selector",At),Qe.registerElement("ueb-selector",At),customElements.define("ueb-ui-slider",It),Qe.registerElement("ueb-ui-slider",It),customElements.define("ueb-window",si),Qe.registerElement("ueb-window",si);export{Mt as Blueprint,te as Configuration,ct as LinkElement,xt as NodeElement};
