 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const It=(e=>(...t)=>({_$litDirective$:e,values:t}))(class extends class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,i){this._$Ct=e,this._$AM=t,this._$Ci=i}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}{constructor(e){var t;if(super(e),e.type!==Ht||"style"!==e.name||(null===(t=e.strings)||void 0===t?void 0:t.length)>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce(((t,i)=>{const n=e[i];return null==n?t:t+`${i=i.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${n};`}),"")}update(e,[t]){const{style:i}=e.element;if(void 0===this.vt){this.vt=new Set;for(const e in t)this.vt.add(e);return this.render(t)}this.vt.forEach((e=>{null==t[e]&&(this.vt.delete(e),e.includes("-")?i.removeProperty(e):i[e]="")}));for(const e in t){const n=t[e];null!=n&&(this.vt.add(e),e.includes("-")?i.setProperty(e,n):i[e]=n)}return O}});class _t extends ct{toggleAdvancedDisplayHandler;getDraggableElement(){return this.element.querySelector(".ueb-window-top")}createDraggableObject(){return new lt(this.element,this.element.blueprint,{draggableElement:this.getDraggableElement(),ignoreTranslateCompensate:!0,movementSpace:this.element.blueprint,stepSize:1})}render(){return L`<div class="ueb-window"><div class="ueb-window-top"><div class="ueb-window-name ueb-ellipsis-nowrap-text">${this.renderWindowName()}</div><div class="ueb-window-close" @click="${()=>this.element.remove()}">${it.close}</div></div><div class="ueb-window-content">${this.renderContent()}</div></div>`}renderWindowName(){return L`Window`}renderContent(){return L``}apply(){this.element.dispatchEvent(new CustomEvent(J.windowApplyEventName)),this.element.remove()}cancel(){this.element.dispatchEvent(new CustomEvent(J.windowCancelEventName)),this.element.remove()}}class Bt extends _t{#ye;#Ee;#we;#Se;#Pe;#ke;#Ce;#xe;#Ne;#Ae;#$e=e=>{const t=ne.clearHTMLWhitespace(e.target.innerHTML),i=parseInt(t,16);isNaN(i)||(this.color.setFromRGBANumber(i),this.element.requestUpdate())};#Te=e=>{const t=ne.clearHTMLWhitespace(e.target.innerHTML),i=parseInt(t,16);isNaN(i)||(this.color.setFromSRGBANumber(i),this.element.requestUpdate())};#Le=e=>t=>{"Enter"==t.code&&(t.preventDefault(),e(t))};#Oe=new pe;get color(){return this.#Oe}set color(e){e.toNumber()!=this.color?.toNumber()&&(this.element.requestUpdate("color",this.#Oe),this.#Oe=e)}#Me=new pe;get fullColor(){return this.#Me}#De;get initialColor(){return this.#De}#He=new pe;#Ie(e,t,i=!1){const n=this.color.toRGBAString(),s=`${n.substring(0,2*e)}${t}${n.substring(2+2*e)}`;return i?`${s.substring(0,6)}FF`:s}connectedCallback(){super.connectedCallback(),this.#De=this.element.windowOptions.getPinColor(),this.color.setFromHSVA(this.initialColor.H.value,this.initialColor.S.value,this.initialColor.V.value,this.initialColor.A.value),this.fullColor.setFromHSVA(this.color.H.value,1,1,1)}firstUpdated(e){this.#ye=this.element.querySelector(".ueb-color-picker-wheel ueb-color-handler"),this.#Ee=this.element.querySelector(".ueb-color-picker-saturation ueb-ui-slider"),this.#we=this.element.querySelector(".ueb-color-picker-value ueb-ui-slider"),this.#Se=this.element.querySelector(".ueb-color-picker-r ueb-ui-slider"),this.#Pe=this.element.querySelector(".ueb-color-picker-g ueb-ui-slider"),this.#ke=this.element.querySelector(".ueb-color-picker-b ueb-ui-slider"),this.#Ce=this.element.querySelector(".ueb-color-picker-a ueb-ui-slider"),this.#xe=this.element.querySelector(".ueb-color-picker-h ueb-ui-slider"),this.#Ne=this.element.querySelector(".ueb-color-picker-s ueb-ui-slider"),this.#Ae=this.element.querySelector(".ueb-color-picker-v ueb-ui-slider"),this.#ye.template.locationChangeCallback=(e,t)=>{this.color.setFromWheelLocation([e,t],this.color.V.value,this.color.A.value),this.fullColor.setFromHSVA(this.color.H.value,1,1,1),this.element.requestUpdate()},this.#Ee.template.locationChangeCallback=(e,t)=>{this.color.setFromHSVA(this.color.H.value,t,this.color.V.value,this.color.A.value),this.element.requestUpdate()},this.#we.template.locationChangeCallback=(e,t)=>{this.color.setFromHSVA(this.color.H.value,this.color.S.value,t,this.color.A.value),this.element.requestUpdate()},this.#Se.template.locationChangeCallback=(e,t)=>{this.color.setFromRGBA(e,this.color.G.value,this.color.B.value,this.color.A.value),this.element.requestUpdate()},this.#Pe.template.locationChangeCallback=(e,t)=>{this.color.setFromRGBA(this.color.R.value,e,this.color.B.value,this.color.A.value),this.element.requestUpdate()},this.#ke.template.locationChangeCallback=(e,t)=>{this.color.setFromRGBA(this.color.R.value,this.color.G.value,e,this.color.A.value),this.element.requestUpdate()},this.#Ce.template.locationChangeCallback=(e,t)=>{this.color.setFromRGBA(this.color.R.value,this.color.G.value,this.color.B.value,e),this.element.requestUpdate()},this.#xe.template.locationChangeCallback=(e,t)=>{this.color.setFromHSVA(e,this.color.S.value,this.color.V.value,this.color.A.value),this.element.requestUpdate()},this.#Ne.template.locationChangeCallback=(e,t)=>{this.color.setFromHSVA(this.color.H.value,e,this.color.V.value,this.color.A.value),this.element.requestUpdate()},this.#Ae.template.locationChangeCallback=(e,t)=>{this.color.setFromHSVA(this.color.H.value,this.color.S.value,e,this.color.A.value),this.element.requestUpdate()}}renderSlider(e){let t="",i=0,n="";const s=e=>`linear-gradient(to right, #${this.#Ie(e,"00",!0)}, #${this.#Ie(e,"ff",!0)})`;switch(e){case 0:t="r",i=this.color.R.value,n=s(e);break;case 1:t="g",i=this.color.G.value,n=s(e);break;case 2:t="b",i=this.color.B.value,n=s(e);break;case 3:t="a",i=this.color.A.value,n=`${J.alphaPattern}, ${s(e)}`;break;case 4:t="h",i=360*this.color.H.value,n="linear-gradient(to right, #f00 0%, #ff0 16.666%, #0f0 33.333%, #0ff 50%, #00f 66.666%, #f0f 83.333%, #f00 100%)";break;case 5:t="s",i=this.color.S.value,n=`linear-gradient(to right,#${this.#He.setFromHSVA(this.color.H.value,0,this.color.V.value,1),this.#He.toRGBAString()},#${this.#He.setFromHSVA(this.color.H.value,1,this.color.V.value,1),this.#He.toRGBAString()})`;break;case 6:t="v",i=this.color.V.value,n=`linear-gradient(to right, #000, #${this.fullColor.toRGBAString()})`}return n=`background: ${n};`,L`<div class="ueb-color-picker-${t.toLowerCase()}"><span class="ueb-color-control-label">${t.toUpperCase()}</span><div><div class="ueb-horizontal-slider"><span class="ueb-horizontal-slider-text" .innerText="${ne.minDecimals(ne.roundDecimals(i,3))}"></span><ueb-ui-slider></ueb-ui-slider></div><div class="ueb-color-picker-gradient" style="${n}"></div></div></div>`}renderContent(){const e=2*this.color.H.value*Math.PI,t={"--ueb-color-r":this.color.R.toString(),"--ueb-color-g":this.color.G.toString(),"--ueb-color-b":this.color.B.toString(),"--ueb-color-a":this.color.A.toString(),"--ueb-color-h":this.color.H.toString(),"--ueb-color-s":this.color.S.toString(),"--ueb-color-v":this.color.V.toString(),"--ueb-color-wheel-x":100*(this.color.S.value*Math.cos(e)*.5+.5)+"%","--ueb-color-wheel-y":100*(this.color.S.value*Math.sin(e)*.5+.5)+"%"},i=this.color.toRGBAString(),n=this.color.toSRGBAString(),s=this.fullColor.toRGBAString();return L`<div class="ueb-color-picker" style="${It(t)}"><div class="ueb-color-picker-toolbar"><div class="ueb-color-picker-theme"></div><div class="ueb-color-picker-srgb"></div></div><div class="ueb-color-picker-main"><div class="ueb-color-picker-wheel"><ueb-color-handler></ueb-color-handler></div><div class="ueb-color-picker-saturation ueb-vertical-slider" style="background-color:#${s}"><ueb-ui-slider></ueb-ui-slider></div><div class="ueb-color-picker-value ueb-vertical-slider" style="background-color:#${s}"><ueb-ui-slider></ueb-ui-slider></div><div class="ueb-color-picker-preview">Old<div class="ueb-color-picker-preview-old" style="background:#${this.#De.toRGBAString()}"></div><div class="ueb-color-picker-preview-new"><div class="ueb-color-picker-preview-1" style="background:#${this.#Ie(3,"FF")}"></div><div class="ueb-color-picker-preview-2" style="background:${`linear-gradient(#${i}, #${i}),${J.alphaPattern}`}"></div></div>New</div></div><div class="ueb-color-picker-advanced-toggle ueb-toggle-control">Advanced</div><div class="ueb-color-picker-advanced"><div class="ueb-color-picker-column">${this.renderSlider(0)} ${this.renderSlider(1)} ${this.renderSlider(2)} ${this.renderSlider(3)}</div><div class="ueb-color-picker-column">${this.renderSlider(4)} ${this.renderSlider(5)} ${this.renderSlider(6)}<div class="ueb-color-control"><span class="ueb-color-control-label">Hex Linear</span><div class="ueb-color-picker-hex-linear ueb-text-input"><ueb-input .innerText="${i}" @focusout="${this.#$e}" @keydown="${this.#Le(this.#$e)}"></ueb-input></div></div><div class="ueb-color-control"><span class="ueb-color-control-label">Hex sRGB</span><div class="ueb-color-picker-hex-srgb ueb-text-input"><ueb-input .innerText="${n}" @focusout="${this.#Te}" @keydown="${this.#Le(this.#Te)}"></ueb-input></div></div></div></div><div class="ueb-buttons"><div class="ueb-color-picker-ok ueb-button" @click="${()=>this.apply()}">OK</div><div class="ueb-color-picker-cancel ueb-button" @click="${()=>this.cancel()}">Cancel</div></div></div>`}renderWindowName(){return L`Color Picker`}}class Rt extends ot{#ge;#_e;#Be=e=>{this.#_e=new(Ke.getConstructor("ueb-window"))({type:Bt,windowOptions:{getPinColor:()=>this.element.defaultValue,setPinColor:e=>this.element.setDefaultValue(e)}}),this.element.blueprint.append(this.#_e);const t=()=>{this.element.setDefaultValue(this.#_e.template.color)},i=()=>{this.#_e.removeEventListener(J.windowApplyEventName,t),this.#_e.removeEventListener(J.windowCloseEventName,i),this.#_e=null};this.#_e.addEventListener(J.windowApplyEventName,t),this.#_e.addEventListener(J.windowCloseEventName,i)};firstUpdated(e){super.firstUpdated(e),this.#ge=this.element.querySelector(".ueb-pin-input")}renderInput(){return L`<span class="ueb-pin-input" data-linear-color="${this.element.defaultValue.toString()}" @click="${this.#Be}" style="--ueb-linear-color:rgba(${this.element.defaultValue.toString()})"></span>`}}class Gt extends Ot{static singleLineInput=!0}class Ft extends Mt{setDefaultValue(e=[],t=e){this.element.setDefaultValue(e[0])}renderInput(){return L`<div class="ueb-pin-input"><ueb-input .singleLine="${!0}" .innerText="${Ot.stringFromUEToInput(ne.minDecimals(this.element.entity.DefaultValue))}"></ueb-input></div>`}}class jt extends ot{renderIcon(){return it.referencePin}}class zt extends Mt{setDefaultValue(e=[],t=e){if(!(this.element.entity.DefaultValue instanceof fe))throw new TypeError("Expected DefaultValue to be a VectorEntity");let i=this.element.entity.DefaultValue;i.R=e[0],i.P=e[1],i.Y=e[2]}renderInput(){return L`<div class="ueb-pin-input-wrapper"><span class="ueb-pin-input-label">X</span><div class="ueb-pin-input"><span class="ueb-pin-input-content ueb-pin-input-x" role="textbox" contenteditable="true" .innerText="${Ot.stringFromUEToInput(this.element.entity.getDefaultValue().R.toString())}"></span></div><span class="ueb-pin-input-label">Y</span><div class="ueb-pin-input"><span class="ueb-pin-input-content ueb-pin-input-y" role="textbox" contenteditable="true" .innerText="${Ot.stringFromUEToInput(this.element.entity.getDefaultValue().P.toString())}"></span></div><span class="ueb-pin-input-label">Z</span><div class="ueb-pin-input"><span class="ueb-pin-input-content ueb-pin-input-z" role="textbox" contenteditable="true" .innerText="${Ot.stringFromUEToInput(this.element.entity.getDefaultValue().Y.toString())}"></span></div></div>`}}class Vt extends Ot{}class Ut extends Mt{setDefaultValue(e,t){if(!(this.element.entity.DefaultValue instanceof Ee))throw new TypeError("Expected DefaultValue to be a VectorEntity");let i=this.element.entity.DefaultValue;i.X=e[0],i.Y=e[1],i.Z=e[2]}renderInput(){return L`<div class="ueb-pin-input-wrapper"><span class="ueb-pin-input-label">X</span><div class="ueb-pin-input"><ueb-input .singleLine="${!0}" .innerText="${Ot.stringFromUEToInput(ne.minDecimals(this.element.entity.getDefaultValue().X))}"></ueb-input></div><span class="ueb-pin-input-label">Y</span><div class="ueb-pin-input"><ueb-input .singleLine="${!0}" .innerText="${Ot.stringFromUEToInput(ne.minDecimals(this.element.entity.getDefaultValue().Y))}"></ueb-input></div><span class="ueb-pin-input-label">Z</span><div class="ueb-pin-input"><ueb-input .singleLine="${!0}" .innerText="${Ot.stringFromUEToInput(ne.minDecimals(this.element.entity.getDefaultValue().Z))}"></ueb-input></div></div>`}}class Kt extends Fe{static#oe={"/Script/CoreUObject.LinearColor":Rt,"/Script/CoreUObject.Rotator":zt,"/Script/CoreUObject.Vector":Ut,bool:Tt,exec:Lt,int:Dt,MUTABLE_REFERENCE:jt,name:Gt,real:Ft,string:Vt};static properties={pinId:{type:ae,converter:{fromAttribute:(e,t)=>e?Te.grammar.Guid.parse(e).value:null,toAttribute:(e,t)=>e?.toString()},attribute:"data-id",reflect:!0},pinType:{type:String,attribute:"data-type",reflect:!0},advancedView:{type:String,attribute:"data-advanced-view",reflect:!0},color:{type:pe,converter:{fromAttribute:(e,t)=>e?Te.grammar.LinearColorFromAnyColor.parse(e).value:null,toAttribute:(e,t)=>e?ne.printLinearColor(e):null},attribute:"data-color",reflect:!0},defaultValue:{type:String,attribute:!1},isLinked:{type:Boolean,converter:ne.booleanConverter,attribute:"data-linked",reflect:!0},pinDirection:{type:String,attribute:"data-direction",reflect:!0}};static getTypeTemplate(e){return Kt.#oe[e.PinType.bIsReference&&!e.PinType.bIsConst?"MUTABLE_REFERENCE":e.getType()]??ot}nodeElement;connections=0;constructor(e,t,i){super(e,t??new(Kt.getTypeTemplate(e))),this.pinId=this.entity.PinId,this.pinType=this.entity.getType(),this.advancedView=this.entity.bAdvancedView,this.defaultValue=this.entity.getDefaultValue(),this.color=Kt.properties.color.converter.fromAttribute(this.getColor().toString()),this.isLinked=!1,this.pinDirection=e.isInput()?"input":e.isOutput()?"output":"hidden",this.nodeElement=i,this.entity.subscribe("PinToolTip",(e=>{let t=e.match(/\s*(.+?(?=\n)|.+\S)\s*/);return t?ne.formatStringName(t[1]):ne.formatStringName(this.entity.PinName)}))}getPinId(){return this.entity.PinId}getPinName(){return this.entity.PinName}getPinDisplayName(){let e=null;return this.entity.PinToolTip&&(e=this.entity.PinToolTip.match(/\s*(.+?(?=\n)|.+\S)\s*/))?ne.formatStringName(e[1]):ne.formatStringName(this.entity.PinName)}getColor(){return this.pinType?J.pinColor[this.pinType]:J.pinColor.default}isInput(){return this.entity.isInput()}isOutput(){return this.entity.isOutput()}getLinkLocation(){return this.template.getLinkLocation()}getNodeElement(){return this.nodeElement}getLinks(){return this.entity.LinkedTo??[]}setDefaultValue(e){this.entity.DefaultValue=e,this.defaultValue=e}sanitizeLinks(e=[]){this.entity.LinkedTo=this.getLinks().filter((t=>{let i=this.blueprint.getPin(t);if(i){if(e.length&&!e.includes(i.nodeElement))return!1;this.blueprint.getLink(this,i,!0)||this.blueprint.addGraphElement(new(Ke.getConstructor("ueb-link"))(this,i))}return i}))}linkTo(e){this.entity.linkTo(e.getNodeElement().getNodeName(),e.entity)&&(this.isLinked=this.entity.isLinked(),this.nodeElement?.template.linksChanged())}unlinkFrom(e){this.entity.unlinkFrom(e.getNodeElement().getNodeName(),e.entity)&&(this.isLinked=this.entity.isLinked(),this.nodeElement?.template.linksChanged())}redirectLink(e,t){const i=this.entity.LinkedTo.findIndex((t=>t.objectName.toString()==e.getNodeElement().getNodeName()&&t.pinGuid.valueOf()==e.entity.PinId.valueOf()));return i>=0&&(this.entity.LinkedTo[i]=t,!0)}}class Wt extends je{static#oe={window:_t,"color-picker":Bt};static properties={...je.properties,type:{type:_t,attribute:"data-type",reflect:!0,converter:{fromAttribute:(e,t)=>Wt.#oe[e],toAttribute:(e,t)=>Object.entries(Wt.#oe).find((([t,i])=>e==i))[0]}}};constructor(e={}){e.type.constructor==String&&(e.type=Wt.#oe[e.type]),e.type??=_t,e.windowOptions??={},super({},new e.type),this.type=e.type,this.windowOptions=e.windowOptions}disconnectedCallback(){super.disconnectedCallback(),this.dispatchCloseEvent()}dispatchCloseEvent(){let e=new CustomEvent(J.windowCloseEventName);this.dispatchEvent(e)}}class Xt extends Te{constructor(e,t,i,n,s,r,o){e=e??(e=>`(${e})`),super(t,i,n,s,r,o),this.wrap=e}read(e){const t=$e.getGrammarForType(Te.grammar,this.entityType).parse(e);if(!t.status)throw new Error(`Error when trying to parse the entity ${this.entityType.prototype.constructor.name}.`);return t.value}write(e,t,i=!1){return this.wrap(this.subWrite(e,[],t,i))}}class qt extends Xt{#Re;constructor(e,t){super(void 0,t),this.#Re=e}write(e,t,i=!1){return this.#Re(t,i)}}class Yt extends Xt{constructor(e){super(void 0,e)}write(e,t,i){return i||t.constructor!==String?ne.escapeString(t.toString()):`"${ne.escapeString(t.toString())}"`}}!function(){const e=e=>`(${e})`;te.registerSerializer(null,new qt(((e,t)=>"()"),null)),te.registerSerializer(Array,new qt(((e,t)=>`(${e.map((e=>te.getSerializer(ne.getType(e)).serialize(e,t)+",")).join("")})`),Array)),te.registerSerializer(Boolean,new qt(((e,t)=>e?t?"true":"True":t?"false":"False"),Boolean)),te.registerSerializer(oe,new Xt(e,oe)),te.registerSerializer(ae,new Yt(ae)),te.registerSerializer(le,new Yt(le)),te.registerSerializer(ue,new Yt(ue)),te.registerSerializer(ce,new Xt((e=>`${ce.lookbehind}(${e})`),ce,"",", ",!1,"",(e=>""))),te.registerSerializer(he,new Xt(e,he)),te.registerSerializer(pe,new Xt(e,pe)),te.registerSerializer(me,new Xt((e=>`${me.lookbehind}(${e})`),me,"",", ",!1,"",(e=>""))),te.registerSerializer(ge,new Xt(e,ge)),te.registerSerializer(Number,new qt((e=>e.toString()),Number)),te.registerSerializer(ke,new Le),te.registerSerializer(re,new qt((e=>(e.type??"")+(e.path?e.type?`'"${e.path}"'`:`"${e.path}"`:"")),re)),te.registerSerializer(be,new Yt(be)),te.registerSerializer(Se,new Xt((e=>`${Se.lookbehind} (${e})`),Se,"",",",!0)),te.registerSerializer(ve,new Xt((e=>e),ve,""," ",!1,"",(e=>""))),te.registerSerializer(de,new Yt(de)),te.registerSerializer(fe,new Xt(e,fe)),te.registerSerializer(String,new qt(((e,t)=>t?ne.escapeString(e):`"${ne.escapeString(e)}"`),String)),te.registerSerializer(ye,new qt(((e,t)=>`${e.P}, ${e.Y}, ${e.R}`),ye)),te.registerSerializer(we,new qt(((e,t)=>`${e.X}, ${e.Y}, ${e.Z}`),we)),te.registerSerializer(Ee,new Xt(e,Ee))}(),customElements.define("ueb-color-handler",kt),Ke.registerElement("ueb-color-handler",kt),customElements.define("ueb-input",At),Ke.registerElement("ueb-input",At),customElements.define("ueb-link",nt),Ke.registerElement("ueb-link",nt),customElements.define("ueb-node",gt),Ke.registerElement("ueb-node",gt),customElements.define("ueb-pin",Kt),Ke.registerElement("ueb-pin",Kt),customElements.define("ueb-selector",yt),Ke.registerElement("ueb-selector",yt),customElements.define("ueb-ui-slider",xt),Ke.registerElement("ueb-ui-slider",xt),customElements.define("ueb-window",Wt),Ke.registerElement("ueb-window",Wt);export{Et as Blueprint,J as Configuration,nt as LinkElement,gt as NodeElement};
