 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const di="important",mi=" !"+di,gi=(e=>(...t)=>({_$litDirective$:e,values:t}))(class extends pi{constructor(e){var t;if(super(e),e.type!==hi||"style"!==e.name||(null===(t=e.strings)||void 0===t?void 0:t.length)>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce(((t,i)=>{const n=e[i];return null==n?t:t+`${i=i.includes("-")?i:i.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${n};`}),"")}update(e,[t]){const{style:i}=e.element;if(void 0===this.ht){this.ht=new Set;for(const e in t)this.ht.add(e);return this.render(t)}this.ht.forEach((e=>{null==t[e]&&(this.ht.delete(e),e.includes("-")?i.removeProperty(e):i[e]="")}));for(const e in t){const n=t[e];if(null!=n){this.ht.add(e);const t="string"==typeof n&&n.endsWith(mi);e.includes("-")||t?i.setProperty(e,t?n.slice(0,-11):n,t?di:""):i[e]=n}}return V}});class bi extends At{toggleAdvancedDisplayHandler;getDraggableElement(){return this.element.querySelector(".ueb-window-top")}createDraggableObject(){return new Nt(this.element,this.blueprint,{draggableElement:this.getDraggableElement(),ignoreScale:!0,ignoreTranslateCompensate:!1,movementSpace:this.blueprint,stepSize:1})}setup(){const e=this.blueprint.template.gridLeftVisibilityBoundary(),t=this.blueprint.template.gridTopVisibilityBoundary();this.element.locationX=this.blueprint.scaleCorrectReverse(this.blueprint.mousePosition[0]-e),this.element.locationY=this.blueprint.scaleCorrectReverse(this.blueprint.mousePosition[1]-t),this.element.updateComplete.then((()=>{const e=this.blueprint.getBoundingClientRect();this.element.locationX+this.element.sizeX>e.width&&(this.element.locationX=e.width-this.element.sizeX),this.element.locationX=Math.max(0,this.element.locationX),this.element.locationY+this.element.sizeY>e.height&&(this.element.locationY=e.height-this.element.sizeY),this.element.locationY=Math.max(0,this.element.locationY)}))}render(){return z`<div class="ueb-window"><div class="ueb-window-top"><div class="ueb-window-name ueb-ellipsis-nowrap-text">${this.renderWindowName()}</div><div class="ueb-window-close" @click="${()=>this.element.remove()}">${_e.close}</div></div><div class="ueb-window-content">${this.renderContent()}</div></div>`}renderWindowName(){return z`Window`}renderContent(){return z``}apply(){this.element.dispatchEvent(new CustomEvent(re.windowApplyEventName)),this.element.remove()}cancel(){this.element.dispatchEvent(new CustomEvent(re.windowCancelEventName)),this.element.remove()}}class yi extends bi{#Qe;#Je;#et;#tt;#it;#nt;#st;#rt;#at;#ot;#lt=e=>{const t=he.clearHTMLWhitespace(e.target.innerHTML),i=parseInt(t,16);isNaN(i)||(this.color.setFromRGBANumber(i),this.element.requestUpdate())};#ut=e=>{const t=he.clearHTMLWhitespace(e.target.innerHTML),i=parseInt(t,16);isNaN(i)||(this.color.setFromSRGBANumber(i),this.element.requestUpdate())};#ct=e=>t=>{"Enter"==t.code&&(t.preventDefault(),e(t))};#de=new Ae;get color(){return this.#de}set color(e){e.toNumber()!=this.color?.toNumber()&&(this.element.requestUpdate("color",this.#de),this.#de=e)}#ht=new Ae;get fullColor(){return this.#ht}#pt;get initialColor(){return this.#pt}#dt=new Ae;#mt(e,t,i=!1){const n=this.color.toRGBAString(),s=`${n.substring(0,2*e)}${t}${n.substring(2+2*e)}`;return i?`${s.substring(0,6)}FF`:s}initialize(e){super.initialize(e),this.#pt=this.element.windowOptions.getPinColor(),this.color.setFromHSVA(this.initialColor.H.value,this.initialColor.S.value,this.initialColor.V.value,this.initialColor.A.value),this.fullColor.setFromHSVA(this.color.H.value,1,1,1)}firstUpdated(e){this.#Qe=this.element.querySelector(".ueb-color-picker-wheel ueb-color-handler"),this.#Je=this.element.querySelector(".ueb-color-picker-saturation ueb-ui-slider"),this.#et=this.element.querySelector(".ueb-color-picker-value ueb-ui-slider"),this.#tt=this.element.querySelector(".ueb-color-picker-r ueb-ui-slider"),this.#it=this.element.querySelector(".ueb-color-picker-g ueb-ui-slider"),this.#nt=this.element.querySelector(".ueb-color-picker-b ueb-ui-slider"),this.#st=this.element.querySelector(".ueb-color-picker-a ueb-ui-slider"),this.#rt=this.element.querySelector(".ueb-color-picker-h ueb-ui-slider"),this.#at=this.element.querySelector(".ueb-color-picker-s ueb-ui-slider"),this.#ot=this.element.querySelector(".ueb-color-picker-v ueb-ui-slider"),this.#Qe.template.locationChangeCallback=(e,t)=>{this.color.setFromWheelLocation(e,t,this.color.V.value,this.color.A.value),this.fullColor.setFromHSVA(this.color.H.value,1,1,1),this.element.requestUpdate()},this.#Je.template.locationChangeCallback=(e,t)=>{this.color.setFromHSVA(this.color.H.value,t,this.color.V.value,this.color.A.value),this.element.requestUpdate()},this.#et.template.locationChangeCallback=(e,t)=>{this.color.setFromHSVA(this.color.H.value,this.color.S.value,t,this.color.A.value),this.element.requestUpdate()},this.#tt.template.locationChangeCallback=(e,t)=>{this.color.setFromRGBA(e,this.color.G.value,this.color.B.value,this.color.A.value),this.element.requestUpdate()},this.#it.template.locationChangeCallback=(e,t)=>{this.color.setFromRGBA(this.color.R.value,e,this.color.B.value,this.color.A.value),this.element.requestUpdate()},this.#nt.template.locationChangeCallback=(e,t)=>{this.color.setFromRGBA(this.color.R.value,this.color.G.value,e,this.color.A.value),this.element.requestUpdate()},this.#st.template.locationChangeCallback=(e,t)=>{this.color.setFromRGBA(this.color.R.value,this.color.G.value,this.color.B.value,e),this.element.requestUpdate()},this.#rt.template.locationChangeCallback=(e,t)=>{this.color.setFromHSVA(e,this.color.S.value,this.color.V.value,this.color.A.value),this.element.requestUpdate()},this.#at.template.locationChangeCallback=(e,t)=>{this.color.setFromHSVA(this.color.H.value,e,this.color.V.value,this.color.A.value),this.element.requestUpdate()},this.#ot.template.locationChangeCallback=(e,t)=>{this.color.setFromHSVA(this.color.H.value,this.color.S.value,e,this.color.A.value),this.element.requestUpdate()}}renderSlider(e){let t="",i=0,n="";const s=e=>`linear-gradient(to right, #${this.#mt(e,"00",!0)}, #${this.#mt(e,"ff",!0)})`;switch(e){case 0:t="r",i=this.color.R.value,n=s(e);break;case 1:t="g",i=this.color.G.value,n=s(e);break;case 2:t="b",i=this.color.B.value,n=s(e);break;case 3:t="a",i=this.color.A.value,n=`${re.alphaPattern}, ${s(e)}`;break;case 4:t="h",i=360*this.color.H.value,n="linear-gradient(to right, #f00 0%, #ff0 16.666%, #0f0 33.333%, #0ff 50%, #00f 66.666%, #f0f 83.333%, #f00 100%)";break;case 5:t="s",i=this.color.S.value,n=`linear-gradient(to right,#${this.#dt.setFromHSVA(this.color.H.value,0,this.color.V.value,1),this.#dt.toRGBAString()},#${this.#dt.setFromHSVA(this.color.H.value,1,this.color.V.value,1),this.#dt.toRGBAString()})`;break;case 6:t="v",i=this.color.V.value,n=`linear-gradient(to right, #000, #${this.fullColor.toRGBAString()})`}return n=`background: ${n};`,z`<div class="ueb-color-picker-${t.toLowerCase()}"><span class="ueb-color-control-label">${t.toUpperCase()}</span><div><div class="ueb-horizontal-slider"><span class="ueb-horizontal-slider-text" .innerText="${he.printNumber(he.roundDecimals(i,3))}"></span><ueb-ui-slider></ueb-ui-slider></div><div class="ueb-color-picker-gradient" style="${n}"></div></div></div>`}renderContent(){const e=2*this.color.H.value*Math.PI,t={"--ueb-color-r":this.color.R.toString(),"--ueb-color-g":this.color.G.toString(),"--ueb-color-b":this.color.B.toString(),"--ueb-color-a":this.color.A.toString(),"--ueb-color-h":this.color.H.toString(),"--ueb-color-s":this.color.S.toString(),"--ueb-color-v":this.color.V.toString(),"--ueb-color-wheel-x":100*(this.color.S.value*Math.cos(e)*.5+.5)+"%","--ueb-color-wheel-y":100*(this.color.S.value*Math.sin(e)*.5+.5)+"%"},i=this.color.toRGBAString(),n=this.color.toSRGBAString(),s=this.fullColor.toRGBAString();return z`<div class="ueb-color-picker" style="${gi(t)}"><div class="ueb-color-picker-toolbar"><div class="ueb-color-picker-theme"></div><div class="ueb-color-picker-srgb"></div></div><div class="ueb-color-picker-main"><div class="ueb-color-picker-wheel"><ueb-color-handler></ueb-color-handler></div><div class="ueb-color-picker-saturation ueb-vertical-slider" style="background-color:#${s}"><ueb-ui-slider></ueb-ui-slider></div><div class="ueb-color-picker-value ueb-vertical-slider" style="background-color:#${s}"><ueb-ui-slider></ueb-ui-slider></div><div class="ueb-color-picker-preview">Old<div class="ueb-color-picker-preview-old" style="background:#${this.#pt.toRGBAString()}"></div><div class="ueb-color-picker-preview-new"><div class="ueb-color-picker-preview-1" style="background:#${this.#mt(3,"FF")}"></div><div class="ueb-color-picker-preview-2" style="background:${`linear-gradient(#${i}, #${i}),${re.alphaPattern}`}"></div></div>New</div></div><div class="ueb-color-picker-advanced-toggle ueb-toggle-control">Advanced</div><div class="ueb-color-picker-advanced"><div class="ueb-color-picker-column">${this.renderSlider(0)} ${this.renderSlider(1)} ${this.renderSlider(2)} ${this.renderSlider(3)}</div><div class="ueb-color-picker-column">${this.renderSlider(4)} ${this.renderSlider(5)} ${this.renderSlider(6)}<div class="ueb-color-control"><span class="ueb-color-control-label">Hex Linear</span><div class="ueb-color-picker-hex-linear ueb-text-input"><ueb-input .innerText="${i}" @focusout="${this.#lt}" @keydown="${this.#ct(this.#lt)}"></ueb-input></div></div><div class="ueb-color-control"><span class="ueb-color-control-label">Hex sRGB</span><div class="ueb-color-picker-hex-srgb ueb-text-input"><ueb-input .innerText="${n}" @focusout="${this.#ut}" @keydown="${this.#ct(this.#ut)}"></ueb-input></div></div></div></div><div class="ueb-buttons"><div class="ueb-color-picker-ok ueb-button" @click="${()=>this.apply()}">${re.windowApplyButtonText}</div><div class="ueb-color-picker-cancel ueb-button" @click="${()=>this.cancel()}">${re.windowCancelButtonText}</div></div></div>`}renderWindowName(){return z`${re.colorWindowName}`}}class fi extends Vt{#gt;#bt=e=>{e.preventDefault(),this.blueprint.setFocused(!0),this.#gt=mt.getConstructor("ueb-window").newObject({type:new yi,windowOptions:{getPinColor:()=>this.element.defaultValue,setPinColor:e=>this.element.setDefaultValue(e)}}),this.blueprint.append(this.#gt);const t=()=>{this.element.setDefaultValue(this.#gt.template.color)},i=()=>{this.#gt.removeEventListener(re.windowApplyEventName,t),this.#gt.removeEventListener(re.windowCloseEventName,i),this.#gt=null};this.#gt.addEventListener(re.windowApplyEventName,t),this.#gt.addEventListener(re.windowCloseEventName,i)};renderInput(){return z`<span class="ueb-pin-input-wrapper ueb-pin-input" data-linear-color="${this.element.getDefaultValue()?.toString()??O}" @click="${this.#bt}" style="--ueb-linear-color:rgba(${this.element.getDefaultValue()?.toString()??O})"></span>`}}class vi extends ri{static singleLineInput=!0}class wi extends li{setDefaultValue(e=[],t=e){this.element.setDefaultValue(e[0])}renderInput(){return z`<div class="ueb-pin-input-wrapper ueb-pin-input"><ueb-input .singleLine="${!0}" .innerText="${he.printNumber(this.element.getDefaultValue()??0)}"></ueb-input></div>`}}class Ei extends Vt{renderIcon(){return _e.referencePin}}class Si extends li{#yt(){return he.printNumber(this.element.getDefaultValue()?.R??0)}#ft(){return he.printNumber(this.element.getDefaultValue()?.P??0)}#vt(){return he.printNumber(this.element.getDefaultValue()?.Y??0)}setDefaultValue(e=[],t=e){const i=this.element.getDefaultValue(!0);if(!(i instanceof Ie))throw new TypeError("Expected DefaultValue to be a RotatorEntity");i.R=e[0],i.P=e[1],i.Y=e[2],this.element.requestUpdate("DefaultValue",i)}renderInput(){return z`<div class="ueb-pin-input-wrapper"><span class="ueb-pin-input-label">X</span><div class="ueb-pin-input"><ueb-input .singleLine="${!0}" .innerText="${this.#yt()}"></ueb-input></div><span class="ueb-pin-input-label">Y</span><div class="ueb-pin-input"><ueb-input .singleLine="${!0}" .innerText="${this.#ft()}"></ueb-input></div><span class="ueb-pin-input-label">Z</span><div class="ueb-pin-input"><ueb-input .singleLine="${!0}" .innerText="${this.#vt()}"></ueb-input></div></div>`}}class Ci extends ri{}class xi extends li{#wt(){return he.printNumber(this.element.getDefaultValue()?.X??0)}#vt(){return he.printNumber(this.element.getDefaultValue()?.Y??0)}setDefaultValue(e,t){const i=this.element.getDefaultValue(!0);if(!(i instanceof De))throw new TypeError("Expected DefaultValue to be a Vector2DEntity");i.X=e[0],i.Y=e[1],this.element.requestUpdate("DefaultValue",i)}renderInput(){return z`<div class="ueb-pin-input-wrapper"><span class="ueb-pin-input-label">X</span><div class="ueb-pin-input"><ueb-input .singleLine="${!0}" .innerText="${this.#wt()}"></ueb-input></div><span class="ueb-pin-input-label">Y</span><div class="ueb-pin-input"><ueb-input .singleLine="${!0}" .innerText="${this.#vt()}"></ueb-input></div></div>`}}class Ni extends li{#wt(){return he.printNumber(this.element.getDefaultValue()?.X??0)}#vt(){return he.printNumber(this.element.getDefaultValue()?.Y??0)}#Et(){return he.printNumber(this.element.getDefaultValue()?.Z??0)}setDefaultValue(e,t){const i=this.element.getDefaultValue(!0);if(!(i instanceof Ve))throw new TypeError("Expected DefaultValue to be a VectorEntity");i.X=e[0],i.Y=e[1],i.Z=e[2],this.element.requestUpdate("DefaultValue",i)}renderInput(){return z`<div class="ueb-pin-input-wrapper"><span class="ueb-pin-input-label">X</span><div class="ueb-pin-input"><ueb-input .singleLine="${!0}" .innerText="${this.#wt()}"></ueb-input></div><span class="ueb-pin-input-label">Y</span><div class="ueb-pin-input"><ueb-input .singleLine="${!0}" .innerText="${this.#vt()}"></ueb-input></div><span class="ueb-pin-input-label">Z</span><div class="ueb-pin-input"><ueb-input .singleLine="${!0}" .innerText="${this.#Et()}"></ueb-input></div></div>`}}class ki extends ut{static#St={bool:si,byte:ui,enum:ai,int:ui,int64:ci,MUTABLE_REFERENCE:Ei,name:vi,real:wi,string:Ci,[re.paths.linearColor]:fi,[re.paths.rotator]:Si,[re.paths.vector]:Ni,[re.paths.vector2D]:xi};static properties={pinId:{type:Se,converter:{fromAttribute:(e,t)=>e?Ye.guidEntity.parse(e).value:null,toAttribute:(e,t)=>e?.toString()},attribute:"data-id",reflect:!0},pinType:{type:String,attribute:"data-type",reflect:!0},advancedView:{type:String,attribute:"data-advanced-view",reflect:!0},color:{type:Ae,converter:{fromAttribute:(e,t)=>e?Ye.linearColorFromAnyFormat.parse(e).value:null,toAttribute:(e,t)=>e?he.printLinearColor(e):null},attribute:"data-color",reflect:!0},defaultValue:{type:String,attribute:!1},isLinked:{type:Boolean,converter:he.booleanConverter,attribute:"data-linked",reflect:!0},pinDirection:{type:String,attribute:"data-direction",reflect:!0},connectable:{type:Boolean,converter:he.booleanConverter,attribute:"data-connectable",reflect:!0}};nodeElement;static getTypeTemplate(e){if("Array"===e.PinType.ContainerType?.toString())return Vt;if(e.PinType.bIsReference&&!e.PinType.bIsConst)return ki.#St.MUTABLE_REFERENCE;if("exec"===e.getType())return oi;let t;return e.isInput()&&(t=ki.#St[e.getType()]),t??Vt}static newObject(e=new Re,t=new(ki.getTypeTemplate(e)),i=void 0){const n=new ki;return n.initialize(e,t,i),n}initialize(e=new Re,t=new(ki.getTypeTemplate(e)),i=void 0){this.nodeElement=i,this.advancedView=e.bAdvancedView,this.isLinked=!1,this.connectable=!e.bNotConnectable,super.initialize(e,t),this.pinType=this.entity.getType(),this.defaultValue=this.entity.getDefaultValue(),this.color=ki.properties.color.converter.fromAttribute(this.getColor().toString()),this.pinDirection=e.isInput()?"input":e.isOutput()?"output":"hidden"}setup(){super.setup(),this.nodeElement=this.closest("ueb-node")}createPinReference(){return new Be({objectName:this.nodeElement.getNodeName(),pinGuid:this.getPinId()})}getPinId(){return this.entity.PinId}getPinName(){return this.entity.PinName}getPinDisplayName(){return this.entity.pinDisplayName()}getColor(){return this.entity.pinColor()}isInput(){return this.entity.isInput()}isOutput(){return this.entity.isOutput()}getLinkLocation(){return this.template.getLinkLocation()}getNodeElement(){return this.nodeElement}getLinks(){return this.entity.LinkedTo??[]}getDefaultValue(e=!1){return this.defaultValue=this.entity.getDefaultValue(e)}setDefaultValue(e){this.entity.DefaultValue=e,this.defaultValue=e}sanitizeLinks(e=[]){this.entity.LinkedTo=this.entity.LinkedTo?.filter((t=>{let i=this.blueprint.getPin(t);if(i){if(e.length&&!e.includes(i.nodeElement))return!1;let t=this.blueprint.getLink(this,i);t||(t=mt.getConstructor("ueb-link").newObject(this,i),this.blueprint.addGraphElement(t))}return i})),this.isLinked=this.entity.isLinked()}linkTo(e){const t=this.createPinReference();!this.isLinked||!this.isOutput()||"exec"!==this.pinType&&"exec"!==e.pinType||this.getLinks().some((e=>t.equals(e)))||this.unlinkFromAll(),this.entity.linkTo(e.getNodeElement().getNodeName(),e.entity)&&(this.isLinked=this.entity.isLinked(),this.nodeElement?.template.linksChanged())}unlinkFrom(e,t=!0){this.entity.unlinkFrom(e.getNodeElement().getNodeName(),e.entity)&&(this.isLinked=this.entity.isLinked(),this.nodeElement?.template.linksChanged(),t&&this.blueprint.getLink(this,e)?.remove())}unlinkFromAll(){const e=this.getLinks().length;this.getLinks().map((e=>this.blueprint.getPin(e))).forEach((e=>this.unlinkFrom(e))),e&&this.nodeElement?.template.linksChanged()}redirectLink(e,t){const i=this.getLinks().findIndex((t=>t.objectName.toString()==e.getNodeElement().getNodeName()&&t.pinGuid.valueOf()==e.entity.PinId.valueOf()));return i>=0&&(this.entity.LinkedTo[i]=t,!0)}}class Pi{constructor(e=(e=>e),t=null){this.array=new Uint32Array(t),this.comparisonValueSupplier=e,this.length=0,this.currentPosition=0}get(e){return e>=0&&e<this.length?this.array[e]:null}getArray(){return this.array}getPosition(e){let t=0,i=this.length;for(;t<i;){let n=Math.floor((t+i)/2);this.comparisonValueSupplier(this.array[n])<e?t=n+1:i=n}return t}reserve(e){if(this.array.length<e){let t=new Uint32Array(e);t.set(this.array),this.array=t}}insert(e,t=null){let i=this.getPosition(this.comparisonValueSupplier(e));return(i<this.currentPosition||null!=t&&i==this.currentPosition&&this.comparisonValueSupplier(e)<t)&&++this.currentPosition,this.shiftRight(i),this.array[i]=e,++this.length,i}remove(e){let t=this.getPosition(this.comparisonValueSupplier(e));this.array[t]==e&&this.removeAt(t)}removeAt(e){return e<this.currentPosition&&--this.currentPosition,this.shiftLeft(e),--this.length,e}getNext(){return this.currentPosition>=0&&this.currentPosition<this.length?this.get(this.currentPosition):null}getNextValue(){return this.currentPosition>=0&&this.currentPosition<this.length?this.comparisonValueSupplier(this.get(this.currentPosition)):Number.MAX_SAFE_INTEGER}getPrev(){return this.currentPosition>0?this.get(this.currentPosition-1):null}getPrevValue(){return this.currentPosition>0?this.comparisonValueSupplier(this.get(this.currentPosition-1)):Number.MIN_SAFE_INTEGER}shiftLeft(e,t=1){this.array.set(this.array.subarray(e+t),e)}shiftRight(e,t=1){this.array.set(this.array.subarray(e,-t),e+t)}}class Ai{constructor(e,t,i,n){this.initialPosition=e,this.finalPosition=e,this.metadata=new Array(t.length),this.primaryOrder=new Pi((e=>this.metadata[e].primaryBoundary)),this.secondaryOrder=new Pi((e=>this.metadata[e].secondaryBoundary)),this.selectFunc=n,this.rectangles=t,this.primaryOrder.reserve(this.rectangles.length),this.secondaryOrder.reserve(this.rectangles.length),t.forEach(((e,t)=>{let s={primaryBoundary:this.initialPosition[0],secondaryBoundary:this.initialPosition[1],rectangle:t,onSecondaryAxis:!1};this.metadata[t]=s,n(e,!1);const r=i(e);this.initialPosition[1]<r.secondaryInf?s.secondaryBoundary=r.secondaryInf:r.secondarySup<this.initialPosition[1]?s.secondaryBoundary=r.secondarySup:s.onSecondaryAxis=!0,this.initialPosition[0]<r.primaryInf?(s.primaryBoundary=r.primaryInf,this.primaryOrder.insert(t)):r.primarySup<this.initialPosition[0]?(s.primaryBoundary=r.primarySup,this.primaryOrder.insert(t)):r.secondarySup<this.initialPosition[1]||this.initialPosition[1]<r.secondaryInf?this.secondaryOrder.insert(t):n(e,!0)})),this.primaryOrder.currentPosition=this.primaryOrder.getPosition(this.initialPosition[0]),this.secondaryOrder.currentPosition=this.secondaryOrder.getPosition(this.initialPosition[1]),this.computeBoundaries()}computeBoundaries(){this.boundaries={primaryN:{v:this.primaryOrder.getPrevValue(),i:this.primaryOrder.getPrev()},primaryP:{v:this.primaryOrder.getNextValue(),i:this.primaryOrder.getNext()},secondaryN:{v:this.secondaryOrder.getPrevValue(),i:this.secondaryOrder.getPrev()},secondaryP:{v:this.secondaryOrder.getNextValue(),i:this.secondaryOrder.getNext()}}}selectTo(e){const t=[Math.sign(e[0]-this.initialPosition[0]),Math.sign(e[1]-this.initialPosition[1])],i=(i,n)=>{if(this.metadata[i].onSecondaryAxis)this.selectFunc(this.rectangles[i],n);else if(n){this.secondaryOrder.insert(i,e[1]);const n=this.metadata[i].secondaryBoundary;Math.sign(e[1]-n)==t[1]&&Math.sign(n-this.initialPosition[1])==t[1]&&this.selectFunc(this.rectangles[i],!0)}else this.selectFunc(this.rectangles[i],!1),this.secondaryOrder.remove(i);this.computeBoundaries(),this.selectTo(e)};e[0]<this.boundaries.primaryN.v?(--this.primaryOrder.currentPosition,i(this.boundaries.primaryN.i,this.initialPosition[0]>this.boundaries.primaryN.v&&e[0]<this.initialPosition[0])):e[0]>this.boundaries.primaryP.v&&(++this.primaryOrder.currentPosition,i(this.boundaries.primaryP.i,this.initialPosition[0]<this.boundaries.primaryP.v&&this.initialPosition[0]<e[0]));const n=(t,i)=>{this.selectFunc(this.rectangles[t],i),this.computeBoundaries(),this.selectTo(e)};e[1]<this.boundaries.secondaryN.v?(--this.secondaryOrder.currentPosition,n(this.boundaries.secondaryN.i,this.initialPosition[1]>this.boundaries.secondaryN.v&&e[1]<this.initialPosition[1])):e[1]>this.boundaries.secondaryP.v&&(++this.secondaryOrder.currentPosition,n(this.boundaries.secondaryP.i,this.initialPosition[1]<this.boundaries.secondaryP.v&&this.initialPosition[1]<e[1])),this.finalPosition=e}}class Li extends wt{}class Mi extends vt{selectionModel=null;constructor(){super(),super.initialize({},new Li)}static newObject(){return new Mi}initialize(){}beginSelect(e){const t=this.blueprint.constructor;this.blueprint.selecting=!0,this.setBothLocations(e),this.selectionModel=new Ai(e,this.blueprint.getNodes(),t.nodeBoundariesSupplier,t.nodeSelectToggleFunction)}selectTo(e){this.selectionModel.selectTo(e),this.toX=e[0],this.toY=e[1]}endSelect(){this.blueprint.selecting=!1,this.selectionModel=null,this.fromX=0,this.fromY=0,this.toX=0,this.toY=0}}class Ti extends ct{static#Ct={window:bi,"color-picker":yi};static properties={...ct.properties,type:{type:bi,attribute:"data-type",reflect:!0,converter:{fromAttribute:(e,t)=>Ti.#Ct[e],toAttribute:(e,t)=>Object.entries(Ti.#Ct).find((([t,i])=>e.constructor===i))?.[0]}}};static newObject(e={},t=e.type??new bi){const i=new Ti;return i.initialize(e,t),i}initialize(e={},t=e.type??new bi){e.windowOptions??={},this.type=e.type,this.windowOptions=e.windowOptions,super.initialize(e,t)}computeSizes(){const e=this.getBoundingClientRect();this.sizeX=e.width,this.sizeY=e.height}cleanup(){super.cleanup(),this.acknowledgeClose()}acknowledgeClose(){let e=new CustomEvent(re.windowCloseEventName);this.dispatchEvent(e)}}class Bi extends Qe{#xt;constructor(e,t){super(t),this.#xt=e}doWrite(e,t,i=""){return this.#xt(e,t)}}class $i extends Qe{constructor(e){super(e)}doWrite(e,t,i=""){return t||e.constructor!==String?he.escapeString(e.toString()):`"${he.escapeString(e.toString())}"`}}ue.registerSerializer(null,new Bi(((e,t)=>"()"),null)),ue.registerSerializer(Array,new Bi(((e,t)=>`(${e.map((e=>ue.getSerializer(he.getType(e)).write(e,t)+",")).join("")})`),Array)),ue.registerSerializer(BigInt,new $i(BigInt)),ue.registerSerializer(Boolean,new Bi(((e,t)=>e?t?"true":"True":t?"false":"False"),Boolean)),ue.registerSerializer(me,new $i(me)),ue.registerSerializer(ge,new $i(ge)),ue.registerSerializer(fe,new $i(fe)),ue.registerSerializer(ye,new $i(ye)),ue.registerSerializer(Ee,new Bi(((e,t)=>Ee.lookbehind+"("+e.value.map((e=>ue.getSerializer(he.getType(e)).write(e,t))).join(", ")+")"),Ee)),ue.registerSerializer(xe,new Qe(xe,Qe.bracketsWrapped)),ue.registerSerializer(Se,new $i(Se)),ue.registerSerializer(Ne,new $i(Ne)),ue.registerSerializer(ke,new $i(ke)),ue.registerSerializer(de,new $i(de)),ue.registerSerializer(ve,new Qe(ve,((e,t)=>`${ve.lookbehind}(${t})`),", ",!1,"",(()=>""))),ue.registerSerializer(Pe,new Qe(Pe,Qe.bracketsWrapped)),ue.registerSerializer(Ae,new Qe(Ae,Qe.bracketsWrapped)),ue.registerSerializer(we,new Qe(we,((e,t)=>`${we.lookbehind}(${t})`),", ",!1,"",(()=>""))),ue.registerSerializer(Le,new Qe(Le,Qe.bracketsWrapped)),ue.registerSerializer(le,new Bi(((e,t)=>ue.getSerializer(e.getTargetType()).write(e.get(),t)),le)),ue.registerSerializer(Number,new $i(Number)),ue.registerSerializer(je,new Je),ue.registerSerializer(Ce,new Bi((e=>(e.type??"")+(e.path?e.type?`'"${e.path}"'`:`"${e.path}"`:"")),Ce)),ue.registerSerializer(Te,new $i(Te)),ue.registerSerializer(Re,new Qe(Re,((e,t)=>`${Re.lookbehind} (${t})`),",",!0)),ue.registerSerializer(Be,new Qe(Be,void 0," ",!1,"",(()=>""))),ue.registerSerializer(Ze,new Qe(Ze,Qe.bracketsWrapped)),ue.registerSerializer(Ie,new Qe(Ie,Qe.bracketsWrapped)),ue.registerSerializer(String,new Bi(((e,t)=>t?he.escapeString(e):`"${he.escapeString(e)}"`),String)),ue.registerSerializer(He,new Bi(((e,t)=>`${e.P}, ${e.Y}, ${e.R}`),He)),ue.registerSerializer(ze,new Bi(((e,t)=>`${e.X}, ${e.Y}`),ze)),ue.registerSerializer(Oe,new Bi(((e,t)=>`${e.X}, ${e.Y}, ${e.Z}`),Oe)),ue.registerSerializer(be,new $i(be)),ue.registerSerializer(qe,new Qe(qe,((e,t)=>`${e.lookbehind??""}(${t})`))),ue.registerSerializer(Ge,new Qe(Ge,Qe.bracketsWrapped)),ue.registerSerializer(De,new Qe(De,Qe.bracketsWrapped)),ue.registerSerializer(Ve,new Qe(Ve,Qe.bracketsWrapped)),function(){const e=(e,t)=>{customElements.define(e,t),mt.registerElement(e,t)};e("ueb-color-handler",Xt),e("ueb-dropdown",ti),e("ueb-input",ni),e("ueb-link",xt),e("ueb-node",Ut),e("ueb-pin",ki),e("ueb-selector",Mi),e("ueb-ui-slider",Qt),e("ueb-window",Ti)}();export{Wt as Blueprint,re as Configuration,xt as LinkElement,Ut as NodeElement,he as Utility};
