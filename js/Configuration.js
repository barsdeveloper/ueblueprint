...
export default class Configuration {
    ...
    static pinColor = {
        [this.paths.niagaraBool]: css`146, 0, 0`,
        [this.paths.niagaraDataInterfaceVolumeTexture]: css`0, 168, 242`,
        [this.paths.niagaraFloat]: css`160, 250, 68`,
        [this.paths.niagaraMatrix]: css`0, 88, 200`,
        [this.paths.niagaraPosition]: css`251, 146, 251`,
        [this.paths.quat4f]: css`0, 88, 200`,
        [this.paths.rotator]: css`157, 177, 251`,
        [this.paths.transform]: css`227, 103, 0`,
        [this.paths.vector]: css`251, 198, 34`,
        [this.paths.vector3f]: css`250, 200, 36`,
        [this.paths.vector4f]: css`0, 88, 200`,
        "Any": css`132, 132, 132`,
        "Any[]": css`132, 132, 132`,
        "blue": css`0, 0, 255`,
        "bool": css`146, 0, 0`,
